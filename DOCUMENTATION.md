...
> **Running prompts automatically across multiple LLMs:** Use [Relay App](https://relay.app) — free plan ($0, no credit card required, 500 AI credits/month). A ready-to-use monthly LLM brand visibility monitor template is available to import directly — no workflow setup needed.
>
> **3 steps to get started:**
>
> **1. Import the template** (free):
> [monthly-llm-brand-visibility-monitor](https://run.relay.app/shared/monthly-llm-brand-visibility-monitor-Mi4Qsu6ozt7R)
>
> **2. Personalize it for your company** — replace the XXX placeholders by running this prompt in Claude:
> *"Can you please adapt this workflow for my company instead of the current one. My company name is: XXX, my website is XXX, my blog is XXX. Please also help fix any required setup adjustment."*
>
> **3. Run a test** and review your initial results.
>
> The workflow runs monthly and sends results by email automatically. Use the prompts from `05-LLM-PROMPTS.md` (generated by this agent) to replace the default queries with ones tailored to your business.
