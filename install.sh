...
mkdir -p ~/.claude/skills/answer-readiness-content-audit
...
# Copy skills
cp skills/answer-readiness-content-audit/SKILL.md ~/.claude/skills/answer-readiness-content-audit/
echo "✅ answer-readiness-content-audit skill installed"
